...

;;;### (autoloads nil "format-all" "../../../../../../.emacs.d/elpa/format-all-20200513.1930/format-all.el"
;;;;;;  "2ded2f05ee74604e8e0a34005b9d2b5f")
;;; Generated autoloads from ../../../../../../.emacs.d/elpa/format-all-20200513.1930/format-all.el
...

;;;### (autoloads "actual autoloads are elsewhere" "format-all" "../../../../../../.emacs.d/elpa/format-all-20200513.1930/format-all.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from ../../../../../../.emacs.d/elpa/format-all-20200513.1930/format-all.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "format-all" '("asmfmt" "bibtex-mode" "black" "brittany" "buildifier" "cmake-format" "crystal" "dartfmt" "define-format-all-formatter" "dfmt" "dhall" "dockfmt" "elm-format" "emacs-lisp" "fish-indent" "format-all-" "fprettify" "gofmt" "html-tidy" "istyle-verilog" "jsonnetfmt" "ktlint" "latexindent" "ledger-mode" "lua-fmt" "mix-format" "nixfmt" "ocp-indent" "perltidy" "prettier" "purty" "rufo" "rustfmt" "scalafmt" "shfmt" "snakefmt" "sqlformat" "styler" "swiftformat" "terraform-fmt")))

;;;***

;;;***

;;;### (autoloads nil nil ("../../../../../../.emacs.d/elpa/format-all-20200513.1930/format-all-autoloads.el"
;;;;;;  "../../../../../../.emacs.d/elpa/format-all-20200513.1930/format-all.el")
;;;;;;  (0 0 0 0))
